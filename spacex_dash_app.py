...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]['class'].value_counts().reset_index(name='class count')
...
def get_payload_scatter_chart(entered_site, range_value):
    filtered_df = spacex_df[(spacex_df['Payload Mass (kg)']>=range_value[0]) & (spacex_df['Payload Mass (kg)']<=range_value[1])]
    if entered_site == 'ALL':
